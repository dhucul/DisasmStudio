...
internal static class Dialogs
{
    ...
    private static readonly Brush Muted = new SolidColorBrush(Color.FromRgb(0x8A, 0x95, 0xA9));
    ...
    public static (string Asm, bool Nop)? AskPatch(Window owner, ulong va, string currentText, string currentBytes, string prefill = "")
    {
        ...
        var bytes = new TextBlock { Text = currentBytes, Foreground = new SolidColorBrush(Color.FromRgb(0x8A, 0x95, 0xA9)), FontFamily = mono, Margin = new Thickness(0, 0, 0, 10) };
    ...
    public static BpDef? AskBreakpointEdit(Window owner, BpDef current)
    {
        ...
        {
            Foreground = new SolidColorBrush(Color.FromRgb(0xD8, 0x5F, 0x6A)),
    ...
    {
        Text = text,
        Foreground = new SolidColorBrush(Color.FromRgb(0xDC, 0xE2, 0xEC)),
